...
passi = 100;
ti = 6.8;  % tempo iniziale
tf = 11.8; % tempo finale
...
a5 = polyval(p5,T);  %valutazione del polinomio p3 in funzione del tempo T
...
for cont=1:passi
    ...
    f0c(1:3,cont) = F_vincolari(1:3,1);
    fc1(1:3,cont) = F_vincolari(1:3,2);
    f12(1:3,cont) = F_vincolari(1:3,3);
    f23(1:3,cont) = F_vincolari(1:3,4);
    f34(1:3,cont) = F_vincolari(1:3,5);
    f45(1:3,cont) = F_vincolari(1:3,6);
